    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="AddStudentModalLabel">Add Trainee Data</h5>
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editModalLabel">Edit & Update Trainee Data</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
...
<div class="modal fade" id="DeleteModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Delete Trainee Data</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                ...
                <div class="card-header">
                    <h4>
                        ...
                        <button type="button" class="btn btn-primary float-end" data-bs-toggle="modal"
                            data-bs-target="#AddStudentModal">Add Trainee</button>
                    </h4>
                </div>
                <div class="card-body">
        ...
        function fetchstudent() {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('tbody').html("");
                    $.each(response.trainees, function (key, item) {
                        $('tbody').append('<tr>\
                            <td>' + item.id + '</td>\
                            <td>' + item.name + '</td>\
                            <td>' + item.course + '</td>\
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status == 404) {
                        ...
                        // console.log(response.trainee.name);
                        $('#name').val(response.trainee.name);
                        $('#course').val(response.trainee.course);
                        $('#email').val(response.trainee.email);
                        $('#phone').val(response.trainee.phone);
                        $('#stud_id').val(stud_id);
                    }
                }
            });
